...
#     def __init__(self):
#         self.stumps = []  # List to store stumps
#
#     def fit_incremental(self, X, y, n_stumps):
#         """
#         Incrementally trains stumps and returns training accuracy after each stump.
#         """
#         n_samples, n_classes = X.shape[0], len(np.unique(y))
#         score = np.zeros((n_samples, n_classes))  # Initial scores
#         train_accuracies = []
#
...
#             predictions = stump.predict_proba(X)
#             score += predictions
#
#             # Store the stump
...
#             train_accuracies.append(accuracy_score(y, y_pred))
#
#         return train_accuracies
#
#     def predict(self, X):
#         """
#         Predicts using the ensemble of stumps.
#         """
#         n_samples, n_classes = X.shape[0], len(self.stumps[0].classes_)
#         score = np.zeros((n_samples, n_classes))
#
#         for stump in self.stumps:
#             score += stump.predict_proba(X)
#
